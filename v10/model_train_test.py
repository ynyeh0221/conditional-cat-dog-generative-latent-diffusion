...
# -----------------------------
class CIFAR10CatDog(datasets.CIFAR10):
    def __init__(self, *args, **kwargs):
        super(CIFAR10CatDog, self).__init__(*args, **kwargs)
        # CIFAR-10 classes are: ['airplane','automobile','bird','cat','deer','dog','frog','horse','ship','truck']
        # cat index is 3 and dog index is 5.
        cat_dog_idx = [3, 5]
        mask = np.isin(self.targets, cat_dog_idx)
...
def generate_samples_grid(autoencoder, diffusion, n_per_class=5, save_dir="./results"):
    ...
    description = (
        "This visualization shows images generated by the conditional diffusion model using a VAE decoder on the CIFAR-10 Cat/Dog dataset.\n"
